...
function TaskBoard({ tasks, categories, onToggle, onMove, onCompose }: { tasks: any[]; categories: any[]; onToggle: (task: any) => void; onMove: (task: any, lane: TaskBoardLaneId) => void; onCompose: () => void }) {
